...
% Voor wie is dit?
Het doelpubliek van de updater zijn de ontwikkelaars die anders deze aanpassingen aan de broncode manueel uitvoeren.
...
De Angular update guide door het \textcite{AngularUpdateGuide2025} geeft een uitgebreid overzicht van alle aanpassingen die nodig zijn om een Angular-applicatie van v16 naar v20 te updaten. 
...
Het LSP, als omschreven door \textcite{Bork2023}, is een open protocol voor gebruik in verschillende code-editors of integrated development environments (IDEs) dat pro\-gram\-meertaal-specifieke functies voorziet zoals: automatisch code aanvullen en code-diagnostiek. 
