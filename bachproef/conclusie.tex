...
Dit is lager dan het verwachte resultaat van 65\% uit het onderzoeksvoorstel, zie hoofdstuk~\ref{sec:verwachte_resultaten}.
...
Verder hebben we de updater uitgevoerd op 1 applicatie binnen Stater.
Hieruit blijkt dat de updater op deze applicatie een totaal van 143 regels code heeft kunnen aanpassen.
Na de aanpassingen hebben we 12 foutieve regels code opgespoord.
Het totaal aantal lijnen code dat aangepast moest worden in deze applicatie is onbekend.
Om dit totaal te vinden is een grondige analyse van de volledige codebase nodig.
Dit soort analyse was niet mogelijk vanwege moeilijkheden rondom confidentialiteit.
\medskip
