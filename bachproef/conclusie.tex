...
Alle rijen buiten \emph{n.v.t.} onder \emph{Verandering} zijn wederzijds inclusief, zoals besproken in Hoofdstuk~\ref{ch:soorten-aanpassingen}.
Elke kolom bevat zowel een absolute als een relatieve waarde.
De relatieve waarde is relatief tegenover de eerste rij in de kolom genaamd \emph{\#Stappen}.
\medskip

Uit het totaal van de 80 uit te voeren stappen blijkt dat 27,5\% volledig en 10\% deels automatiseerbaar is.
Dit is is lager dan het verwachte resultaten van 65\%.
...
De hoge flexibiliteit van onze aanpak maakt het mogelijk voor de updater te herconfigureren voor toekomstige updates.
...
Verder hebben we een onderscheiding kunnen maken tussen het soort aanpassingen, syntactisch of semantisch.
\medskip
...
In dit onderzoek legden we de nadruk op de meest voorkomende: zoek- \& vervang, language-servers en compiler-tooling.
\medskip
...
In Hoofdstuk~\ref{ch:stand-van-zaken:refactoring:known-problems} besproken we kort wat de gekende problemen waren bij het refactoren van code.
