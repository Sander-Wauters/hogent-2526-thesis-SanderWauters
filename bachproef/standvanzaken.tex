...
% Wat is Angular?
Angular, ook wel Angular 2 genoemd, is een user interface (UI) framework ontwikkeld door Google in 2016 \autocite{Cincovic2019}.
...
% Wat is propery binding?
% Wat is event binding?
% Wat is two-way binding?

\subsection{Dependency injection}
\label{ch:stand-van-zaken:angular:dependency-injection}

% Wat is dependency injection?
% Hoe gebruikt Angular dependency injection?
