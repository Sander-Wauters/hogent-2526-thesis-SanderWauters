...
In Angular zijn componenten TypeScript-klassen met de \mintinline{ts}{@Component} decorator.
...
% Wat is een template?
Angular-componenten maken gebruik van templates om de structuur van de UI te definiëren.
...
Templates breiden de mogelijkheden van HTML uit met nieuwe syntax specifiek aan Angular.
...
% Wat is data binding?
Data binding is een manier om een databron met een bestemming te verbinden.
...
De tweede soort noemt ``property binding''.
...
De derde soort noemt ``event binding''.
...
De laatste soort is two-way binding.
...
% Wat zijn services?
Services zijn herbruikbare stukken code die gedeeld kunnen worden over meerdere componenten.
...
Angular komt met CLI-tools om automatisch unit-testen te genereren.
...
Startende vanaf Angular v20 is het Vitest-testing-framework de standaard.
Jasmine is nog steeds volledig ondersteund en is wat gebruikt wordt in dit onderzoek.
