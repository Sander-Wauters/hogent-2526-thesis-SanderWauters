...
Property binding is een manier om dynamisch data aan een HTML-element of een andere component mee te geven.
Het is one-way binding
...
Hieruit formuleren we het volgende antwoord op de deelvraag: hoeveel veranderingen moeten uitgevoerd worden om Angular van v16 naar v20 te updaten?
...
\begin{itemize}
  ...
  \item In v19 is er een aanpassing aan de werking van interpolation in bepaalde randgevallen.
  \item In v20 is er een aanpassing aan de werking van interpolation in bepaalde randgevallen.
  \item \dots
\end{itemize}
...
Tijdens het schrijven van dit onderzoek worden v2 to en met v17 niet ondersteunt \autocite{AngularReleasesDocs2025}.
