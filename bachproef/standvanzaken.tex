...
% Wat is Angular?
Angular, ook wel Angular2 genoemd, is een user interface (UI) framework ontwikkeld door Google in 2016. % citation needed
...
Een component is een zelfstandige, herbruikbare bouwblok dat in combinatie met andere componenten een UI vormt. % citation needed

% Hoe werkt het?
Het is een opinionated framework.
Dit wil zeggen dat het komt met een specifieke structuur en richtlijnen waar een applicatie zich aan moet houden. % citation needed
% Wat kan het?
Het framework komt ingebouwd met verschillende functionaliteiten dat de ontwikkeling van applicatie vereenvoudigt. % citation needed
