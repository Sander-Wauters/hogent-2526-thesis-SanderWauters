...
Om dit doel te bereiken krijgt Angular om de 6 maanden een nieuwe ``major'' versie.

Angular-versies worden omschreven in drie delen: ``major'', ``minor'' en ``patch'' \textcite{AngularReleasesDocs2025}.
Patches zijn bugfixes aan de achterliggende werking van Angular.
Bij deze updates is er geen ondersteuning van de ontwikkelaar nodig.
Minor updates voegen nieuwe ``kleine'' functionaliteiten toe.
Hierbij is het de ontwikkelaar die beslist of deze functionaliteiten toegepast worden in zijn applicaties.
Tenslotte zijn er de major updates.
Major updates voegen nieuwe ``grote'' functionaliteiten toe.
Deze updates verwachten in de meeste gevallen extra input.
Dit kan in de vorm van code refactoren, extra testen uitvoeren, nieuwe API's leren, \dots.

Dit onderzoek focust op de major updates.
Alle verwijzingen naar Angular versies verwijzen naar de major updates.

Voor we beginnen met de omschrijving van de verschillen tussen Anguler v16 en v20 zijn er nog enkele elementen waar men zich van bewust moet zijn.
Nieuwe Angular-versies zijn tijdsgebonden en komen uit om de 6 maanden \autocite{AngularReleasesDocs2025}.
...
Het een aanpassing zijn aan de dependencies van Angular, zoals ondersteuning voor een nieuwere versie van TypeScript.

Tenslotte zijn niet alle aanpassingen aan Angular zichtbaar in onze code.
...
Hier is het belangrijk om te vermelden dat bij een nieuwe major update sommige functionaliteiten niet meer ondersteund worden.
Verder worden deze functies verwijderd uit het framework op het moment dat een stabiele vervanging beschikbaar is.
...
Deze handleiding focust exclusief op aanpassingen die een ontwikkelaar moet uitvoeren op zijn applicaties.
Het gaat hier vooral over verouderde of verwijderde functies vervangen.
De Angular-updatehandleiding vormt de basis van welke aanpassingen onderzocht worden.
...
\begin{itemize}
  ...
  \item Bij elke nieuwe versie moet een commando uitgevoerd worden om de Angular ``core''- en ``cli''-afhankelijkheden te updaten.
  \item Verschillende functies veranderen van naam.
  \item Verschillende functies worden vervangen door andere functies.
  \item Verschillende functies worden verwijderd, omdat Angular hun functionaliteiten als standaard toepast.
  ...
  \item In v17 worden gelijkheidstesten in templates strikter. De werking moet overal nagegaan worden.
  ...
  \item In v19 is er een aanpassing aan de werking van interpolatie in bepaalde randgevallen.
  \item In v20 is er een aanpassing aan de werking van interpolatie in bepaalde randgevallen.
  \item \dots
\end{itemize}

\section{Noodzaak van de update}
\label{ch:stand-van-zaken:noodzaak-van-de-update}
