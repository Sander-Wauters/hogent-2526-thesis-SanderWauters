...
Deze services worden geinjecteert in een klasse via de constructor of de \mintinline{ts}{inject()} functie.
...
Tijdens het schrijven van dit onderzoek worden v2 tot en met v17 niet ondersteunt \autocite{AngularReleasesDocs2025}.
