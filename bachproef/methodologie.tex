...
Dit onderzoek stelt een updater op voor de testapplicatie van Angular v16 tot v20 probeert te updaten.
Buiten de updates uitvoeren zal deze updater optellen wat het kan en niet kan.
Dit onderzoek kiest ervoor de resultaten in categorieën te verdelen om zo een beter zicht te krijgen op de voor- en nadelen van de gekozen aanpak.
Elke stap in het updateproces wordt manueel gecategoriseerd in de categorieën besproken in hoofdstuk~\ref{ch:angular-aanpassingen}.
Indien de stap vraagt om een verandering aan TypeScript, proberen we deze stap te detecteren en vervolgens te automatiseren.
