...
Op basis van deze evaluatie kiest dit onderzoek om verder te gaan met zoek- \& vervangfuncties in combinatie met compiler-tooling.
...
Bij het uitvoeren van een Angular-update moeten er sowieso al commando's uitgevoerd worden.
